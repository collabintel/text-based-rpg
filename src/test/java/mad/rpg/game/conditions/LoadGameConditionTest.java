...
public class LoadGameConditionTest {

    Condition loadGameCondition;

    Context context;

    @Before
    public void setUp() throws Exception {
        loadGameCondition = new LoadGameCondition();
        context = new GameContext();
    }

    @Test
    public void should_returnTrue_when_loadGameEventConditionCalled() throws Exception {
        context.addEvent(EventType.LOAD_GAME);

        Boolean result = loadGameCondition.test(context);
