...
public class NewGameConditionTest {
    ...
    public void setUp() throws Exception {
        newGameCondition = new NewGameCondition();
        context = new GameContext();
    }

    @Test
    public void should_returnTrue_when_newGameEventConditionCalled() throws Exception {
        context.addEvent(EventType.NEW_GAME);

        Boolean result = newGameCondition.test(context);
