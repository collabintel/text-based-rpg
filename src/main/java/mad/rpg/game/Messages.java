...
public class Messages {
    ...
    public static final String SAVE_CHARACTER_PROMPT = "Do you want to save this character?";
    ...
    public static final String WHERE_DO_YOU_WANT_TO_GO_NOW = "Where do you want to go now?";
